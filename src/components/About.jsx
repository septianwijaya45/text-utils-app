    ...
    <div className="container" style={myStyle}>
        ...
        <div className="container my-3">
            ...
            <div class="form-check form-switch">
                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" value={btnDarkMode} onClick={toggleClick}/>
                <label class="form-check-label" for="flexSwitchCheckDefault">{textDark}</label>
            </div>
        </div>
    </div>
    </>
